...
$EM_CONF[$_EXTKEY] = array(
	...
	'description' => 'Faceted fulltext search for TYPO3. Very easy to install. Fast (tested with over 100.000 records) and flexible (you can write your own indexers). Indexes content directly from the databases (no frontend crawling). AJAX and accessible frontend. Visit kesearch.de for further information.',
	'category' => 'plugin',
	'shy' => 0,
	'version' => '1.6.6',
	'dependencies' => '',
